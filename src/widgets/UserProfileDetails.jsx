...
const UserProfileDetails = ({profile, role}) => {
                        ...
                        <div className="grid gap-4">
                            <div className="field-wrapper">
                                ...
                                <input className={classNames('field-input', {'field-input--error': errors.firstName})}
                                       ...
                                       defaultValue={profile.usr_first_name}
                            ...
                            <div className="field-wrapper">
                                ...
                                <input className={classNames('field-input', {'field-input--error': errors.lastName})}
                                       ...
                                       defaultValue={profile.usr_last_name}
                            ...
                            <div className="field-wrapper">
                                ...
                                <input className={classNames('field-input', {'field-input--error': errors.email})}
                                       ...
                                       id="email"
                                       placeholder="Email"
                                       defaultValue={profile.usr_email}
                        ...
                        <div className="grid gap-4">
                                    ...
                                    render={({field}) => {
                                        return (
                                            <Select
                                                ...
                                                placeholder={profile.usr_country} 
                                                isSearchable={true}
                                                innerRef={field.ref}
                                            />
                                        )
                            ...
                            <div className="field-wrapper">
                                ...
                                <input className="field-input"
                                       type="text"
                                       id="address"
                                       placeholder={profile.usr_address}
                                       {...register('address')}/>
                            </div>
                        </div>
                    </div>
