...
export const PRODUCT_CATEGORIES = [
    ...
    {value: 'Clothing', label: 'Clothing', icon: 'icon-burger-soda-solid', color: 'header'},
    {value: 'Furniture', label: 'Furniture', icon: 'icon-shirt-solid', color: 'red'},
    {value: 'Suitcases & Trolley Bags', label: 'Suitcases & Trolley Bags', icon: 'icon-shirt-solid', color: 'good'},
    {value: 'Strength Training', label: 'Strength Training', icon: 'icon-shirt-solid', color: 'good'},
    {value: 'Sportswear', label: 'Sportswear', icon: 'icon-shirt-solid', color: 'good'},
    {value: 'Strollers & Prams', label: 'Strollers & Prams', icon: 'icon-shirt-solid', color: 'good'},
]
