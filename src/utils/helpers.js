...
export const sortProducts = (products, sort) => {
    switch (sort) {
        ...
        case 'available':
            return products.sort((a, b) => b.product_quantity[0].quantity - a.product_quantity[0].quantity);
        case 'price-low-to-high':
            return products.sort((a, b) => a.product_discounted_price - b.product_discounted_price);
        case 'price-high-to-low':
            return products.sort((a, b) => b.product_discounted_price - a.product_discounted_price);
    }
}
