...
import ROUTESUSER from '@constants/routerUser';
import ROUTESSHOP from '@constants/routerShop';
...
const Sidebar = () => {
    ...
    const [router, serRouter] = useState([]);
    ...
    const fetchData = async () => {
        if(sessionStorage.getItem('x-client-id') && sessionStorage.getItem('x-rtoken-id')) {
            ...
            if(roleUser.roleName === 'admin'){
                ...
                serRouter(ROUTESSHOP);
            }else {
                serRouter(ROUTESUSER);
            }
        };
    }
