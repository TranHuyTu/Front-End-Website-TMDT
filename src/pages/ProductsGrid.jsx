    ...
    if(products && role){
        return (
            <>
                ...
                <ItemsGrid products={products} isDraft={false} role = {role} setCategoryNew = {handleCategoryNew} onRequestNextPage={handleRequestNextPage} onRequestReturnPage={handleRequestReturnPage} page={page}/>
            </>
        )
    }else{
        return (<Loader />)
